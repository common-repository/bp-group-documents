...
class BP_Group_Documents_Newest_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			'(BP Group Documents) ' . sprintf( __( 'Recent Group %s', 'bp-group-documents' ), $this->bp_group_documents_name ), // Name
			array(
				'description' => sprintf( __( 'The most recently uploaded group %s. Only from public groups', 'bp-group-documents' ), $this->bp_group_documents_name ),
...
class BP_Group_Documents_Popular_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			'(BP Group Documents) ' . sprintf( __( 'Popular Group %s', 'bp-group-documents' ), $this->bp_group_documents_name ), // Name
			array(
				'description' => sprintf( __( 'The most commonly downloaded group %s. Only for public groups', 'bp-group-documents' ), $this->bp_group_documents_name ),
				'classname'   => 'bp_group_documents_widget',
			)
		);
	...
	function form( $instance ) {
		...
		if ( BP_GROUP_DOCUMENTS_FEATURED ) {
			...
			<p><label><?php printf( __( 'Show featured %s only', 'bp-group-documents' ), $this->bp_group_documents_name ); ?></label>
				<input type="checkbox" id="<?php echo $this->get_field_id( 'featured' ); ?>" name="<?php echo $this->get_field_name( 'featured' ); ?>" value="1" 
													  <?php
														checked( $featured );
														?>
				>
		...
		<p><input type="checkbox" id="<?php echo $this->get_field_id( 'download_count' ); ?>" name="<?php echo $this->get_field_name( 'download_count' ); ?>" value="1" 
												 <?php
													if ( $download_count ) {
...
class BP_Group_Documents_Usergroups_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			'(BP Group Documents) ' . sprintf( __( '%s in your groups', 'bp-group-documents' ), $this->bp_group_documents_name ), // Name
			array(
				'description' => sprintf( __( '%s for a logged in user\'s groups.', 'bp-group-documents' ), $this->bp_group_documents_name ),
				'classname'   => 'bp_group_documents_widget',
			)
		);
	...
	function form( $instance ) {
		...
		<?php if ( BP_GROUP_DOCUMENTS_FEATURED ) { ?>
			<p><label><?php printf( __( 'Show featured %s only', 'bp-group-documents' ), $this->bp_group_documents_name ); ?></label> <input type="checkbox" id="<?php echo $this->get_field_id( 'featured' ); ?>" name="<?php echo $this->get_field_name( 'featured' ); ?>" value="1" 
									<?php
									checked( $featured );
									?>
				>
...
class BP_Group_Documents_CurrentGroup_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			'(BP Group Documents) ' . sprintf( __( '%s in this group', 'bp-group-documents' ), $this->bp_group_documents_name ), // Name
			array(
				'description' => sprintf( __( '%s for the current group.', 'bp-group-documents' ), $this->bp_group_documents_name ),
				'classname'   => 'bp_group_documents_widget',
			)
		);
